      ...
      <section className="gradient-cyber border-b border-border/50 py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg text-foreground/80 max-w-2xl mx-auto">
            Test your knowledge and track your progress. Each quiz has 5 questions 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-5xl mx-auto">
            {threats?.map((threat) => {
              const userProgress = Array.isArray(progressData)
                ? progressData.find((p: any) => p.threat_id === threat.id)
                : progressData?.threat_id === threat.id
                ? progressData
                : null;
              ...
              return (
                ...
                >
                    ...
                    <div className="bg-accent/10 border border-accent/20 rounded-lg p-3 mb-4">
                      <div className="flex items-center gap-2 text-accent">
                        ...
                        <span className="text-sm font-semibold">
                          Best Score: {userProgress.best_score}/5 ({Math.round((userProgress.best_score/5)*100)}%)
                        </span>
                      </div>
                    </div>
                  )}
                  ...
                  <div className="space-y-2">
                    ...
                    >
                      {user && userProgress ? 'Retake Quiz' : 'Start Quiz'}
                    </Button>
                    <Button 
